...
<body>
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li><a href="meetings.html" class="active">KARYA KAMI</a></li>
                          <li><a href="index.html">ANGGOTA KELAS</a></li>
                          <li class="has-sub">
                              <a href="javascript:void(0)">KEPO KLIK BAE</a>
                              <ul class="sub-menu">
                                  <li><a href="meetings.html">KENANGAN</a></li>
                                  <li><a href="meeting-details.html">TENTANG KAMI</a></li>
                              </ul>
                          </li>
  ...
  <section class="heading-page header-text" id="top">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h6>INI KUMPULAN HASIL KAMI SELAMA KULIAH</h6>
          <h2>KARYA KAMI</h2>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="col-lg-12">
              <div class="filters">
                <ul>
                  <li data-filter="*"  class="active">SEMUA KARYA</li>
                </ul>
              </div>
            </div>
            <div class="col-lg-12">
                ...
                <div class="col-lg-4 templatemo-item-col all soon">
                  <div class="meeting-item">
                    <div class="thumb">
                      ...
                      <a href="meeting-details.html"><img src="assets/images/" alt=""></a>
                    </div>
